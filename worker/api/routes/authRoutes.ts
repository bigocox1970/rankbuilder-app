...
export function setupAuthRoutes(app: Hono<AppEnv>): void {
    ...
    authRouter.post('/impersonate', setAuthLevel(AuthConfig.public), adaptController(AuthController, AuthController.impersonate));
    ...
    authRouter.post('/change-password', setAuthLevel(AuthConfig.authenticated), adaptController(AuthController, AuthController.changePassword));
