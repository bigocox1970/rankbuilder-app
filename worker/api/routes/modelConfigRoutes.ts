...
export function setupModelConfigRoutes(app: Hono<AppEnv>): void {
    ...
    modelConfigRouter.post('/test', setAuthLevel(AuthConfig.adminOnly), adaptController(ModelConfigController, ModelConfigController.testModelConfig));
    modelConfigRouter.post('/reset-all', setAuthLevel(AuthConfig.adminOnly), adaptController(ModelConfigController, ModelConfigController.resetAllConfigs));
